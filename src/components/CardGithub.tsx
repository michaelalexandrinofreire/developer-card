    ...
    <div className="container">
      <div className="card">
        <div className="containerUser">
          <img src={user.avatar_url} alt="Profile" className="card__avatar" />
          <h2 className="card__name">{user.name}</h2>
        </div>
        <div className="containerInformation">
          <p className="card_bio">{user.bio}</p>

          <div className="containerBox">
            <p className="card_repos">
              <svg
                aria-hidden="true"
                height="18"
                viewBox="0 0 16 16"
          ...
          <p className="html_url">{user.html_url}</p>
        </div>
      </div>
    </div>
  );
