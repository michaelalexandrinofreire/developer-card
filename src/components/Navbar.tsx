export default function NavBar(){
 return(
  <header>
   <a href="https://github.com/" className="header-link" target="blank">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="#ffffff" width="20" height="20">
   ...
   <a href="https://api.github.com/users" className="header-link" target="blank">
    🌐 GitHub API
   </a>
  </header>
 )
